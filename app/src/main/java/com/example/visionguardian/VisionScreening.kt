...
class VisionScreening : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (ques9.equals(getString(R.string.question9_choice3))) {
            card_2.visibility = View.GONE
            card_4.visibility = View.GONE
        } else if (ques9.equals(getString(R.string.question9_choice2))) {
    ...
    fun checkDiss(right: String, left: String) {
        if (right.equals(getString(R.string.distance_vision1)) && left.equals(getString(R.string.distance_vision1))) {
